                ...
                >
                    @csrf
                        <div class="text-center">
                            <span class="text-xl">Operadores - Alternar a otro rol</span>
                        </div>
                        <div class="flex flex-row selectorFlex gap-5 items-center">
                            ...
                            dark:text-gray-300 dark:focus:ring-offset-dark-eval-1"> 
                                <option value="administrador bg-red-600"> Administrador</option>
                                <option value="empacador" selected> Empacador </option>
                            </select>
                        </div>
